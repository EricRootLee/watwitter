defmodule WatwitterWeb.TimelineLive.PostComponent do
    ...
    <div id="post-<%= @post.id %>" class="post">
      ...
      <div class="post-content">
        ...
        <div class="post-actions">
          ...
          <%= if current_user_liked?(@current_user, @post) do %>
            <a class="post-action text-red-500" href="#" data-role="like-button" phx-click="like" phx-target="<%= @myself %>">
              <svg viewBox="0 0 24 24" class="post-action-svg">
                <g>
  ...
  def handle_event("like", _, socket) do
    Timeline.like_post(socket.assigns.current_user, socket.assigns.post)
