defmodule Watwitter.AccountsTest do
  ...
  describe "get_user_by_email/1" do
    ...
    test "returns the user if the email exists" do
      %{id: id} = user = params_for(:user) |> register_user()
  ...
  describe "register_user/1" do
    ...
    test "validates email uniqueness" do
      %{email: email} = params_for(:user) |> register_user()
  ...
  describe "apply_user_email/3" do
    ...
    test "validates email uniqueness", %{user: user, password: password} do
      other_user = params_for(:user) |> register_user()
    ...
    test "generates a token", %{user: user} do
      ...
      assert_raise Ecto.ConstraintError, fn ->
        Repo.insert!(%UserToken{
          ...
          user_id: register_user(params_for(:user)).id,
          context: "session"
        })
      end
    end
